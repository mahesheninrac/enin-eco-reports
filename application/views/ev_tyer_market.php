            ...
            <div class="text-start d-flex flex-column">
              <div class="d-flex align-items-center mb-2 gap-3">
                ...
                <div class="d-flex flex-column gap-3 ">
                  <h4 class="title">Tyer Market for EVs in India</h4>
          ...
          <div class="p-3 rounded position-relative overflow-hidden what_included_card ">
            ...
            <div class="text-start d-flex flex-column">
              <div class="d-flex align-items-center mb-2 gap-3">
                <img class="check-box me-2" src="https://rhomotion.com/app/themes/rhomotion-theme/public/images/check.0e6cc9.svg" alt="Check Icon" width="24" height="24">
                <div class="d-flex flex-column gap-3 ">
                  <h4 class="title">Tyer Market for e2w in India</h4>
                  <a href="https://rhomotion.com/research/ev-battery-quarterly-outlook/" class="">learn more</a>
                </div>
              </div>
            </div>
          ...
          <div class="p-3 rounded position-relative overflow-hidden what_included_card ">
            ...
            <div class="text-start d-flex flex-column">
              <div class="d-flex align-items-center mb-2 gap-3">
                <img class="check-box me-2" src="https://rhomotion.com/app/themes/rhomotion-theme/public/images/check.0e6cc9.svg" alt="Check Icon" width="24" height="24">
                <div class="d-flex flex-column gap-3 ">
                  <h4 class="title">Tyer Market for e3w in India</h4>
                  <a href="https://rhomotion.com/research/ev-battery-quarterly-outlook/" class="">learn more</a>
                </div>
              </div>
          ...
          <div class="p-3 rounded position-relative overflow-hidden what_included_card ">
            ...
            <div class="text-start d-flex flex-column">
              <div class="d-flex align-items-center mb-2 gap-3">
                <img class="check-box me-2" src="https://rhomotion.com/app/themes/rhomotion-theme/public/images/check.0e6cc9.svg" alt="Check Icon" width="24" height="24">
                <div class="d-flex flex-column gap-3 ">
                  <h4 class="title">Tyer Market for e4w in India</h4>
                  <a href="https://rhomotion.com/research/ev-battery-quarterly-outlook/" class="">learn more</a>
                </div>
              </div>
          ...
          <div class="p-3 rounded position-relative overflow-hidden what_included_card ">
            ...
            <div class="text-start d-flex flex-column">
              <div class="d-flex align-items-center mb-2 gap-3">
                <img class="check-box me-2" src="https://rhomotion.com/app/themes/rhomotion-theme/public/images/check.0e6cc9.svg" alt="Check Icon" width="24" height="24">
                <div class="d-flex flex-column gap-3 ">
                  <h4 class="title">Tyer Market for eBuses in India</h4>
                  <a href="https://rhomotion.com/research/ev-battery-quarterly-outlook/" class="">learn more</a>
                </div>
              </div>
          ...
          <div class="p-3 rounded position-relative overflow-hidden what_included_card ">
            ...
            <div class="text-start d-flex flex-column">
              <div class="d-flex align-items-center mb-2 gap-3">
                <img class="check-box me-2" src="https://rhomotion.com/app/themes/rhomotion-theme/public/images/check.0e6cc9.svg" alt="Check Icon" width="24" height="24">
                <div class="d-flex flex-column gap-3 ">
                  <h4 class="title">Tyer Market for eCV in India</h4>
                  <a href="https://rhomotion.com/research/ev-battery-quarterly-outlook/" class="">learn more</a>
                </div>
              </div>
            </div>
