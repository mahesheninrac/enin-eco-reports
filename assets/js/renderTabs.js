...
function mapCategories(report) {
    ...
    switch (category) {
        case "overall":
            document.getElementById("overall-market").appendChild(template);
            break;
        case "sales":
            document.getElementById("sales-market").appendChild(template);
            sales.push(report);
            break;

        case "production":
            document.getElementById("production-market").appendChild(template);
            break;
        default:
            break;
    }
